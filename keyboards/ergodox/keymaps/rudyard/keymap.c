 ...
 * ├───────┼─────┼─────┼─────┼─────┼─────┼─────┤     ├─────┼─────┼─────┼─────┼─────┼─────┼───────┤
 * │   ~   │  q  │  w  │  e  │  r  │  t  │ HL3 │     │ TG3 │  y  │  u  │  i  │  o  │  p  │   =   │
 * ├───────┼─────┼─────┼─────╆─────╅─────┤     │     │     ├─────╆─────╅─────┼─────┼─────┼───────┤
 * │  TAB  │  a  │  s  │  d  │  f  │  g  ├─────┤     ├─────┤  h  │  j  │  k  │  l  │ ;/S │   -   │
 * ├───────┼─────┼─────┼─────╄─────╃─────┤ HL2 │     │ C-b ├─────╄─────╃─────┼─────┼─────┼───────┤
 * │ SHIFT │  z  │  x  │  c  │  v  │  b  │     │     │     │  n  │  m  │  ,  │  .  │ //C │   '   │
 * └─┬─────┼─────┼─────┼─────┼─────┼─────┴─────┘     └─────┴─────┼─────┼─────┼─────┼─────┼─────┬─┘
 *   │CAPLK│     │     │ HYP │ ALT │                             │ HL2 │  ←  │  ↓  │  ↑  │  →  │
 *   └─────┴─────┴─────┴─────┴─────┘ ┌─────┬─────┐ ┌─────┬─────┐ └─────┴─────┴─────┴─────┴─────┘
 *                                   │CTLAL│     │ │PG DN│PG UP│
...
[LAYER0] = KEYMAP(
     ...
     // 0          1          2          3          4          5          6
        ...
        KC_TILD,   KC_Q,      KC_W,      KC_E,      KC_R,      KC_T,      HL3,
        KC_TAB,    KC_A,      KC_S,      KC_D,      KC_F,      KC_G,      /********/
        KC_LSFT,   KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,      HL2,
     ...
     // 7          8          9          10         11         12         13
        ...
        C_b,       KC_N,      KC_M,      KC_COMM,   KC_DOT,    CT_SLS,    KC_QUOT,
                              HL2,       KC_LEFT,   KC_DOWN,   KC_UP,     KC_RIGHT,
        KC_PGDN,   KC_PGUP,   /********/
        HL1,       /********/ /********/
...
[LAYER1] = KEYMAP(
    ...
    // RIGHT HAND
    //  7          8          9          10         11         12         13
        _______,   KC_F6,     KC_F7,     KC_F8,     KC_F9,     KC_F10,    RESET,
        _______,   KC_6,      KC_7,      KC_8,      KC_9,      KC_0,      _______,
        /********/ KC_PIPE,   KC_RPRN,   KC_RBRC,   KC_RCBR,   DBL_QUOT,  _______,
        _______,   _______,   KC_COLN,   _______,   _______,   KC_BSLS,   _______,
                              _______,   _______,   _______,   _______,   _______,
        KC_END,    KC_HOME,   /********/
        _______,   /********/ /********/
        _______,   _______,   _______
